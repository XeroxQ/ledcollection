...
class App extends Homey.App {
      ...
      .apply(
        ...
        [
          [
            ...
            Object.assign(
              {
                generator: this.generateLedAlert,
          ...
          [
            { id: "led_stroboscope_white", colors: [[255, 255, 255], [0,0,0]] },
            { id: "led_stroboscope_red", colors: [[255, 0, 0], [255, 255, 255] ] },
            { id: "led_stroboscope_orange", colors: [[255, 85, 0], [255, 255, 255] ] },
            { id: "led_stroboscope_yellow", colors: [[255, 255, 0], [255, 255, 255] ] },
            { id: "led_stroboscope_green", colors: [[0, 255, 0], [255, 255, 255] ] },
            { id: "led_stroboscope_cyan", colors: [[0, 255, 255], [255, 255, 255] ] },
            { id: "led_stroboscope_blue", colors: [[0, 0, 255], [255, 255, 255] ] },
            { id: "led_stroboscope_purple", colors: [[64, 0, 255], [255, 255, 255] ] },
            { id: "led_stroboscope_magenta", colors: [[255, 0, 255], [255, 255, 255] ] },
          ].map((screensaver) =>
            Object.assign(
              {
                generator: this.generateStroboscope,
                options: Object.assign(
          ...
          [{ id: "led_flow", colors: [] }].map((screensaver) =>
            Object.assign(
              {
                generator: this.generateFlow,
                options: Object.assign(
                  { fps: 1, tfps: 60, rpm: 0 },
                  screensaver.options
                ),
          ...
          [{ id: "led_random_colors", colors: [] }].map((screensaver) =>
            Object.assign(
              {
                generator: this.generateRandomColors,
                options: Object.assign(
                  { fps: 1, tfps: 60, rpm: 3 },
                  screensaver.options
                ),
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generateBreathe,
                options: Object.assign(
                  { fps: 1, tfps: 60, rpm: 0 },
                  screensaver.options
                ),
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generateSparkle,
                options: Object.assign(
                  { fps: 4, tfps: 60, rpm: 2 },
                  screensaver.options
                ),
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generateSatellite,
                options: Object.assign(
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generateLighthouse,
                options: Object.assign(
                  { fps: 1, tfps: 60, rpm: 10 },
                  screensaver.options
                ),
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generateClockwork,
                options: Object.assign(
                  { fps: 24, tfps: 60, rpm: 0 },
                  screensaver.options
                ),
              },
              screensaver
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generateButterfly,
                options: Object.assign(
                  { fps: 5, tfps: 60, rpm: 0 },
                  screensaver.options
                ),
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generatePulsetrain,
                options: Object.assign(
                  { fps: 12, tfps: 60, rpm: 17 },
                  screensaver.options
                ),
              },
              screensaver
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generateFrontpulse,
                options: Object.assign(
                  { fps: 9, tfps: 60, rpm: 0 },
                  screensaver.options
                ),
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generatePulsar,
                options: Object.assign(
                  { fps: 12, tfps: 60, rpm: 0 },
                  screensaver.options
                ),
              },
              screensaver
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generateOncoming,
                options: Object.assign(
                  { fps: 12, tfps: 60, rpm: 3 },
                  screensaver.options
                ),
              },
              screensaver
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generateNewtonian,
                options: Object.assign(
                  { fps: 20, tfps: 60, rpm: 0 },
                  screensaver.options
                ),
              },
              screensaver
          ...
          [
            ...
            Object.assign(
              {
                generator: this.generateScannerFrames,
                options: Object.assign(
                  { fps: 3, tfps: 60, rpm: 0 },
                  screensaver.options
                ),
  ...
  generateStroboscope(rgb_1, rgb_2) {
    let frames = [];
  ...
  generateTriangle(colRGB1, colRGB2, colRGB3) {
    var frames = [];
    var frame = [];
  ...
  generateOncoming(colRGB1, colRGB2) {
    var frames = [];
  ...
  generateNewtonian(colRGB1, colRGB2) {
    var frames = [];
    var pixnum1 = 0;
    var pixnum2 = 12;
  ...
  generateLedAlert(colRGB1, colRGB2) {
    var frames = [];
    var frame = [];
    var color = [];
